...
#plotting the map
UDplot.tm<-tm_shape(shagnest_buffer)+tm_borders(lty=2,col="blue")+tm_shape(scot_wgs84,bbox=bbox_shag)+tm_polygons()+tm_shape(eush616_ud95)+tm_fill(col="orange")+tm_scale_bar(position=c("LEFT","BOTTOM"))+tm_grid(n.x=3,n.y=4,lines=F,labels.cardinal=T)+tm_add_legend(type="symbol",col="#006428",labels="Nest site")+tm_shape(shagnest_wgs84.sf)+tm_dots(size=0.5,col="#006428")+tm_credits("Contains data from https://www.mdpi.com/2077-1312/9/3/263#supplementary\nContains Ordnance Survey data © Crown copyright and database right",position=c("LEFT","BOTTOM"),size=0.4)+tm_add_legend(type="line",col="blue",labels="Foraging radius")+tm_add_legend(type="fill",col="orange",labels="Unsuitable for \ntidal development",border.col=NA)+tm_layout(legend.position=c("right","bottom"),legend.text.size=0.6,legend.height = -0.15,legend.bg.color="white",legend.frame="black")
UDplot.tm
